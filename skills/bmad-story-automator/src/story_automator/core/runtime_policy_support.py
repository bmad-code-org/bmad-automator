...
from .runtime_layout import bundled_story_skill_root, resolve_portable_path, resolve_skill_dir
from .utils import ensure_dir, get_project_root, md5_hex8, read_text
from .workflow_steps import VALID_STEP_NAMES
...
def _load_bundled_policy_shape(project_root: str | Path | None = None, bundle_root: Path | None = None) -> dict[str, Any]:
    root = Path(project_root or get_project_root()).resolve()
    bundle_root = bundle_root or bundled_skill_root(root)
